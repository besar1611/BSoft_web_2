...
<head>
  ...
  <!-- Site Title -->
  <title>BSoft - Creative Agency</title>
...
<body>
        ...
        <div class="cs-main_header_in">
          <div class="cs-main_header_left">
            <a class="cs-site_branding" href="index.php">
              <img src="assets/img/logo_bsoft.png" alt="Logo">
            </a>
          </div>
      ...
      <div class="cs-side_header_box">
        ...
        <ul class="cs-contact_info cs-style1 cs-mp0">
          ...
          <li>
            ...
            <span>besar.idrizi@gmail.com</span>
          </li>
          <li>
            ...
            <span>Andrea Stojanoviq 5, <br>1200 Tetovo, North Macedonia </span>
          </li>
        </ul>
      </div>
      <div class="cs-side_header_box">
        <div class="cs-social_btns cs-style1">
          <a href="https://www.linkedin.com/in/besar-idrizi-2b13241a1/" target="_blank" class="cs-center">
          ...
          <a href="https://www.youtube.com/codinger" target="_blank" class="cs-center">
  ...
  <div class="cs-hero cs-style1 cs-bg cs-fixed_bg cs-shape_wrap_1" data-src="assets/img/hero_bg.jpeg" id="home">
    ...
    <div class="container">
      <div class="cs-hero_text">
        ...
        <div class="cs-hero_info">
          ...
          <div>
            <div class="cs-hero_subtitle"> We deliver best problem solving solution for our clients and provide finest
    ...
    <div class="cs-hero_social_wrap cs-primary_font cs-primary_color">
      ...
      <ul class="cs-hero_social_links">
        <li>
          <a href="https://www.facebook.com/bsoft.programming" target="_blank">Facebook</a>
        </li>
        <li>
          <a href="https://www.instagram.com/bsoft.programming/" target="_blank">Instagram</a>
        </li>
        <li>
          <a href="https://www.linkedin.com/in/besar-idrizi-2b13241a1/" target="_blank">Linkedin</a>
        </li>
      </ul>
    </div>
      ...
      <div class="cs-funfact_wrap cs-type1">
        ...
        <div class="cs-funfact_left">
          <div class="cs-funfact_heading">
            <h2>Visionary</h2>
            <p>At the heart of BSoft's success lies a visionary approach to software development. We understand that the
              digital landscape is ever-evolving, and our team of skilled developers is dedicated to staying ahead of
              the curve. By embracing emerging technologies and trends, we empower our clients to not only keep pace
              with change but to lead the way.</p>
          </div>
        </div>
        <div class="cs-funfact_right">
          <h2>Quality Assurance</h2>
          <p>BSoft prides itself on delivering products of the highest quality. Rigorous testing processes are
            integrated into every stage of development to guarantee the reliability, security, and performance of our
            software solutions. This commitment to quality is a testament to our dedication to providing solutions that
      ...
      <div class="row">
        ...
        <div class="col-xl-8">
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="cs-hobble">
                <a href="software_development.php" class="cs-card cs-style1 cs-hover_layer1">
                  <img src="assets/img/service_2.jpeg" alt="Service">
                  <div class="cs-card_overlay"></div>
                  <div class="cs-card_info">
                    <span class="cs-hover_layer3 cs-accent_bg"></span>
                    <h2 class="cs-card_title">Software Development</h2>
                  </div>
                </a>
              </div>
              <div class="cs-height_0 cs-height_lg_30"></div>
  ...
  <section>
    ...
    <div class="cs-slider cs-style3 cs-gap-24">
      ...
      // Query to get the latest 3 portfolio items
      $query = "SELECT * FROM portfolio_t ORDER BY id DESC LIMIT 3";
      $result = $conn->query($query);

      if ($result->num_rows > 0) {
        // Output the HTML structure for the slider
        echo '<div class="cs-slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="1" data-slides-per-view="1">';
        echo '    <div class="cs-slider_wrapper">';
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          echo '                    <div class="cs-portfolio_subtitle">See Details</div>';
          echo '                </div>';
          echo '            </a>';
          echo '        </div>';
        }
  ...
  <div class="container">
    <h2 class="cs-font_50 cs-m0 text-center cs-line_height_4 wow fadeInUp" data-wow-duration="0.8s"
      data-wow-delay="0.2s"> Our agile process is ability to adapt and respond to change. BSoft view change as an
      opportunity, not a threat. </h2>
  </div>

  <!-- <div class="cs-height_70 cs-height_lg_70"></div>

  <div class="container">
    <a href="#" id="playButton" class="cs-video_block cs-style1 cs-video_open cs-bg"
      data-src="assets/img/video_bg_2.jpeg">
      <span class="cs-player_btn cs-accent_color" onclick="playVideo()">
        <span></span>
      </span>
    </a>
  </div> -->
  ...
  <!-- End Team Section -->
  <!-- <div class="cs-height_150 cs-height_lg_40"></div>

  <div class="cs-moving_text_wrap cs-bold cs-primary_font">
    <div class="cs-moving_text_in">
      <div class="cs-moving_text">Our partners</div>
      <div class="cs-moving_text">Our partners</div>
      <div class="cs-moving_text">Our partners</div>
    </div>
  </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-sm-6">
            <div class="cs-footer_item">
              <div class="cs-text_widget">
                <img src="assets/img/logo_bsoft.png" alt="Thumb" width="200px">
                <p>Elevate your business with BSoft - Your Partner in Innovative Software Solutions.</p>
              </div>
              <div class="cs-social_btns cs-style1">
                <a href="https://www.facebook.com/bsoft.programming" target="_blank" class="cs-center">
                ...
                <a href="https://www.instagram.com/bsoft.programming/" target="_blank" class="cs-center">
                  <svg style="color: white" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
          ...
          <div class="col-lg-3 col-sm-9">
            <div class="cs-footer_item">
              ...
              <ul class="cs-menu_widget cs-mp0">
                <li>Andrea Stojanoviq 5, 1200 Tetovo, NMK</li>
                <li>+389 71 307 262</li>
                <li>info@bsoft.mk</li>
              </ul>
            </div>
          </div>
    ...
    <div class="container">
      <div class="cs-bottom_footer">
        <div class="cs-bottom_footer_left">
          <div class="cs-copyright">Copyright ©
            <script>document.write(new Date().getFullYear())</script> BSoft.
          </div>
        </div>
  ...
  <script>
    function playVideo() {
      var videoSrc = "assets/video/bsoft.mp4"; // Adjust the video source path
      var videoContainer = document.querySelector(".cs-video_block");
      videoContainer.innerHTML = '<video controls autoplay style="width: 100%; height: auto;"><source src="' + videoSrc + '" type="video/mp4"></video>';
    }
  </script>
