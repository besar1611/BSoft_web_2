...
<body>
  ...
  $query = "SELECT * FROM portfolio_t WHERE id = $portfolioId";
  ...
  <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="cs-section_heading cs-style1">
            <h3 class="cs-section_subtitle">
              <?php echo $row['category_text']; ?>
            </h3>
    ...
    <!-- Start Portfolio -->
    <?php
    $query = "SELECT * FROM portfolio_images_t WHERE portfolio_id = $portfolioId";
    $result = $conn->query($query);

    if ($result->num_rows > 0) {
      echo '<div class="container">';
      echo '  <div class="cs-portfolio_1_heading">';
      echo '    <div class="cs-section_heading cs-style1">';
      echo '      <h2 class="cs-section_title">Images</h2>';
      echo '    </div>';
      echo '  </div>';
      echo '  <div class="cs-height_90 cs-height_lg_45"></div>';
      echo '</div>';
      echo '<div class="container-fluid">';
      echo '  <div class="container-fluid">';
      echo '    <div class="cs-isotop cs-style1 cs-isotop_col_4 cs-has_gutter_24 cs-lightgallery">';
      echo '      <div class="cs-grid_sizer"></div>';
      ...
      echo '  </div>';
      echo '</div>';
      echo '<div class="cs-height_90 cs-height_lg_40"></div>';
    } else {
      echo "No images found in the portfolio_images_t table";
    }
    ...
    <?php
    // Assuming $currentId is the current project ID
    ...
    // Get the total number of projects from the database (assuming you have a table named 'portfolio_t')
    $totalProjectsQuery = "SELECT COUNT(*) as total FROM portfolio_t";
    ...
    // Ensure next and previous IDs are within bounds
    $nextId = min($nextId, $totalProjects);
    $prevId = max($prevId, 1);

    // Output the HTML for next and previous project links
    echo '<div class="cs-page_navigation cs-center">';
    echo '  <div>';
    if ($currentId > 1) {
        echo '    <a href="portfolio-details.php?id=' . $prevId . '" class="cs-text_btn cs-type1">';
        echo '      <svg width="26" height="12" viewBox="0 0 26 12" fill="none" xmlns="http://www.w3.org/2000/svg">';
        echo '        <path d="M0.469669 5.46967C0.176777 5.76256 0.176777 6.23744 0.469669 6.53033L5.24264 11.3033C5.53553 11.5962 6.01041 11.5962 6.3033 11.3033C6.59619 11.0104 6.59619 10.5355 6.3033 10.2426L2.06066 6L6.3033 1.75736C6.59619 1.46447 6.59619 0.989593 6.3033 0.696699C6.01041 0.403806 5.53553 0.403806 5.24264 0.696699L0.469669 5.46967ZM26 5.25L1 5.25V6.75L26 6.75V5.25Z" fill="currentColor" />';
        echo '      </svg>';
        echo '      <span>Prev Project</span>';
        echo '    </a>';
    }
    echo '  </div>';
    echo '  <div>';
    if ($currentId < $totalProjects) {
        echo '    <a href="portfolio-details.php?id=' . $nextId . '" class="cs-text_btn">';
        echo '      <span>Next Project</span>';
        echo '      <svg width="26" height="12" viewBox="0 0 26 12" fill="none" xmlns="http://www.w3.org/2000/svg">';
        echo '        <path d="M25.5303 6.53033C25.8232 6.23744 25.8232 5.76256 25.5303 5.46967L20.7574 0.696699C20.4645 0.403806 19.9896 0.403806 19.6967 0.696699C19.4038 0.989593 19.4038 1.46447 19.6967 1.75736L23.9393 6L19.6967 10.2426C19.4038 10.5355 19.4038 11.0104 19.6967 11.3033C19.9896 11.5962 20.4645 11.5962 20.7574 11.3033L25.5303 6.53033ZM0 6.75H25V5.25H0V6.75Z" fill="currentColor"></path>';
        echo '      </svg>';
        echo '    </a>';
    }
    echo '  </div>';
...
?>
  ...
  <section>
    <div class="cs-cta cs-style1 cs-bg text-center cs-shape_wrap_1 cs-position_1 rounded-0"
      ...
      <div class="cs-shape_1"></div>
      <div class="cs-cta_in">
        <h2 class="cs-cta_title cs-semi_bold cs-m0">info@bsoft.mk</h2>
      </div>
    </div>
  </section>
  <!-- End CTA -->
